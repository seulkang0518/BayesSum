...
# -----------------
def run_single_experiment(seed, L, q, p, n_gd, n, run_bq, beta, lambda_, lr, weight_decay, num_steps,
                          h0=None, J0=None):
...
# -----------------
def run_many(n_list, seeds, L, q, p, n_gd, beta, lambda_, lr, weight_decay, num_steps):
    ...
    for n in n_list:
        for s in seeds:
            ...
            ksd_mc, logZ_final_mc, nll_final_mc, _, _, _ = run_single_experiment(
                ...
                beta=beta, lambda_ = lambda_, lr=lr, weight_decay=weight_decay, num_steps=num_steps,
                h0=h0, J0=J0
            )
...
if __name__ == "__main__":
    ...
    summary = run_many(n_list, seeds, L, q, p, n_gd, beta, lambda_, lr, weight_decay, num_steps)
